...
function GuideBox() {
	return (
		<div className={styles.toolTip}>
			{/* <!-- Source icon Github: https://icons8.com --> */}
			<div className={styles.wrapButton}>
				<a
					href="https://user-images.githubusercontent.com/74447462/172033457-d99e9b80-6023-408e-967c-46be477fff68.mp4"
					target="_blank"
					rel="noreferrer"
				...
				<a
					...
					href="https://github.com/Khanaru220/khung-cui"
				>
					<svg
